    ...
    <div class="flex-center position-ref full-height">
        <div id="app-vue">
            <div class="content">
                <!-- <div class="form-group row"> -->
                  ...
                  <div class="form-group">
                    ...
                    <input type="text" class="form-control" id="name" name="name" 
                        required v-model="newItem.name" placeholder=" Enter name">
                  </div>
                  <div class="form-group">
                    <label for="age">Age:</label>
                    <input type="number" class="form-control" id="age" name="age" 
                        required v-model="newItem.age" placeholder=" Enter age">
                  </div>
                  <div class="form-group">
                    <label for="profession">Profession:</label>
                    <input type="text" class="form-control" id="profession" name="profession"
                        required v-model="newItem.profession" placeholder=" Enter profession">
                  </div>
                ...
                <div class="alert alert-danger alert-dismissible" v-bind:class="{ hidden: hasError }">
                  <a href="#" class="close" data-dismiss="alert" aria-label="close">&times;</a>
                  <strong>Please fill all the fields!</strong> 
                </div>
     
                <div class="alert alert-danger alert-dismissible" v-bind:class="{ hidden: hasAgeError }">
                  <a href="#" class="close" data-dismiss="alert" aria-label="close">&times;</a>
                  <strong>Please enter valid age!!!</strong> 
                </div>
                


                <div class="alert alert-success alert-dismissible" v-bind:class="{ hidden: hasDeleted }">
                  <a href="#" class="close" data-dismiss="alert" aria-label="close">&times;</a>
